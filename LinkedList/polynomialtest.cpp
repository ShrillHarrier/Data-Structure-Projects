...
int main()
{
	double p1_array[] = {23.0,12.0,3.0,11.0};
	Polynomial *p1 = new Polynomial(4, p1_array);


	/*if(p1->head == nullptr){
		std::cout<<"It's still null"<<endl;
	}*/

	//double list = p1->toArray();

	p1->print();

	std::cout<<p1->evaluate(2.0)<<endl;

	    /*double p1_array[] = {0.0,1.0,3.0};
		Polynomial *p1 = new Polynomial(3,p1_array); // 3 -terms - 0 + X + 3X**2
		cout << "p1: " << endl; 
		p1->print();
		cout << endl; 
